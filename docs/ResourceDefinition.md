...
- <code>[ArrayDimensions]()</code>, <code>[ArrayRank]()</code>, <code>[ArrayDeclareShape]()</code>, <code>[ZeroArrayQ]()</code>, <code>[ArrayNumericQ]()</code>, <code>[ArrayNumberQ]()</code>, <code>[ArrayAllZeroQ]()</code> read and declare shape and element properties
- <code>[ArrayTier]()</code>, <code>[ArrayElementDomain]()</code>, <code>[ArrayElementType]()</code>, <code>[ArrayUnify]()</code>, <code>[ArrayCoerce]()</code> order containers in the tier and element lattices, join a set of them and coerce one along them
