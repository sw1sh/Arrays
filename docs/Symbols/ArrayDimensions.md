...
SeeAlso: [ArrayRank, ZeroArrayQ, ArrayContainerQ, ArrayExplicitQ, ArrayLazyQ, ArraySymbolicQ, ArrayMaterialize, ArrayPart, ReshapeArray]
...
```wl
{ArrayRank[ArraySymbol["T", {2, 3, 4}]], Length[ArrayDimensions[ArraySymbol["T", {2, 3, 4}]]]}
```
...
```wl
{ArrayDimensions[SparseArray[{}, {2, 0}]], ZeroArrayQ[SparseArray[{}, {2, 0}]]}
```
