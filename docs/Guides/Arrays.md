...
- `ArrayLazyQ` test for a lazy container: an inert array-valued interpolating, parametric, function, piecewise or net expression, or a deferred structural tree over explicit containers
